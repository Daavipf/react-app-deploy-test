...
function SelectRole() {
  return (
    <section className="h-screen w-screen flex flex-col justify-center items-center">
      ...
      <div className="w-2/3 my-10 flex flex-wrap justify-center gap-6">
        <Card href="/register-owner" className="w-1/4 bg-white hover:bg-white border-2 border-JReal-100 hover:scale-125 transition-transform duration-300">
          <img src={ownerSVG} alt="img-proprietário" />
          <p className="text-center text-lg text-JReal-100 font-semibold">Proprietário</p>
        </Card>
        <Card href="/register-renter" className="w-1/4 bg-white hover:bg-white border-2 border-JReal-100 hover:scale-125 transition-transform duration-300">
          <img src={renterSVG} alt="img-proprietário" />
          <p className="text-center text-lg text-JReal-100 font-semibold">Inquilino</p>
        </Card>
        <Card href="/register-realtor" className="w-1/4 bg-white hover:bg-white border-2 border-JReal-100 hover:scale-125 transition-transform duration-300">
